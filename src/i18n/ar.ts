const ar: Record<string, string> = {
  ...
  "about.description1": "تتمثّل أولوية مكتبنا في استباق المخاطر القانونية التي قد يواجهها موكلونا وتقديم الحلول الأنسب والأدق لهم.",
  "about.description2": "يضمّ المكتب شركاء ومستشارين ومحامين ذوي خبرة واسعة يقدّمون خدماتهم باللغات الإنجليزية والألمانية والإسبانية والفرنسية والروسية والعربية، لضمان أعلى مستويات الدعم القانوني.",
  "about.cta": "تاريخنا",
