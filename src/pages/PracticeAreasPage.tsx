              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group flex items-center gap-4 p-6 border border-border rounded-xl bg-card hover:border-primary hover:-translate-y-1 transition-all duration-300"
                  >
