    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
            <h4 className="font-serif text-lg text-foreground font-semibold mb-6">{t("footer.quick_links")}</h4>
          ...
          <div>
            <h4 className="font-serif text-lg text-foreground font-semibold mb-6">{t("footer.contact")}</h4>
            <a
