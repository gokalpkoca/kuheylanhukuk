            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group block h-full bg-card border border-border rounded-lg p-7 transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:-translate-y-1"
                >
